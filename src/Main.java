...
public class Main {
    public static void main(String[] args) {
        //заметка 1
       Note note = new Note("Когда бизнес не просто приносит деньги, но и позволяет заниматься тем, что тебе нравится" +
               "," +
       ...
       BigDecimal bigDecimal = new BigDecimal("1121212213");
        ...
        //заметка 3
        Note note2 = new Note("Новогодние праздники для 60% бизнеса - время повышенного спроса. Миллионы людей" +
                " тратят больше среднестатистического, готовы покупать множество подарков сразу, обращаются в " +
                "нестандартные для себя компании, чтобы подарки отличались оригинальностью.",LocalDate.now(),NoteType.IDEA
        , "Бизнес плпан 2");
